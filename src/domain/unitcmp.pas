...
begin
  ...
  AQuery.SQL.Text :=
    ...
    '  c."ni_ANT_id", c."ni_CITY_id", c."ni_CTR_id", c."ni_LYT_id" ' +
...
begin
  ...
  try
    ...
    AQuery.SQL.Text :=
      ...
      '("ni_ANT_id","ni_CITY_id","ni_CTR_id","ni_LYT_id",' +
      '"cv_type","ni_x","ni_y","ni_width","ni_height","cv_text","bl_visible") ' +
      'VALUES (:p_ant,:p_city,:p_ctr,:p_lyt,:p_type,:p_x,:p_y,:p_w,:p_h,:p_text,:p_vis)';
